...
export default function ProblemPage() {
    ...
    return (
        <div className="mt-2 -mx-8 px-8 p2-6 pb-0">
            <div className="flex items-center gap-6 pl-12 py-6 shadow">
                <Link to={'/problemset'} className="p-1 bg-gray-800 rounded-full">
            ...
            <div className="w-1/4">
                <div className="flex justify-start gap-14 ml-12 text-primary-text">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:ml-12">
                {subson === 'prob' && (
