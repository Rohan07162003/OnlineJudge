        ...
        <div className="my-12 pt-20 min-h-screen">
            ...
            <div className="md:ml-32 ml-12 my-16 w-4/5 md:w-3/5">
                <div className="bg-gray-800 sm:rounded-lg">
                    <h1 className="font-semibold text-xl py-2 md:py-5 md:px-5 px-3">Problems</h1>
                    {problems.length > 0 && problems.map((problem,index) => (
                        <Link to={'/problem/'+problem._id} key={index} className={classNames("flex flex-col grid grid-cols-[9fr_1fr] px-1 md:px-4 py-3 whitespace-nowrap",
